                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.news-categories.show', $category) }}" class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.news-categories.edit', $category) }}" class="text-indigo-600 hover:text-indigo-900">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                No categories found. <a href="{{ route('admin.news-categories.create') }}" class="text-purple-600 hover:text-purple-800">Create one</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
