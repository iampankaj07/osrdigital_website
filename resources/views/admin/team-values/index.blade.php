                        ...
                        @foreach($teamValues as $value)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="{{ route('admin.team-values.edit', $value) }}" class="text-indigo-600 hover:text-indigo-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="{{ route('admin.team-values.show', $value) }}" class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <form action="{{ route('admin.team-values.toggle-active', $value) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('admin.team-values.destroy', $value) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this team value?')">
                                        @csrf
                                        @method('DELETE')
