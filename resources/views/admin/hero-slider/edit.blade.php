                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4">{{ old('description', $heroSlider->description) }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="button_text" name="button_text" value="{{ old('button_text', $heroSlider->button_text) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="button_text_secondary" name="button_text_secondary" value="{{ old('button_text_secondary', $heroSlider->button_text_secondary) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="button_url_secondary">Secondary Button URL</label>
                                            <input type="url" class="form-control" id="button_url_secondary" name="button_url_secondary" value="{{ old('button_url_secondary', $heroSlider->button_url_secondary) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @if($heroSlider->image)
                                        <div class="mb-2">
                                            <img src="{{ asset('storage/' . $heroSlider->image) }}" alt="{{ $heroSlider->title }}" style="width: 100%; max-width: 300px; height: auto;">
                                        </div>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', $heroSlider->sort_order) }}" min="0">
