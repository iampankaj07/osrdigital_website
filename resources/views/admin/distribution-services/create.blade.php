...
@section('title', 'Create Distribution Service')
...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Create New Distribution Service</h1>
                <p class="text-gray-600 mt-2">Add a new distribution service to your website</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('admin.distribution-services.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="link" id="link" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('link') border-red-500 @enderror" value="{{ old('link', '/business') }}" placeholder="/business">
                        @error('link')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" id="description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('description') border-red-500 @enderror" required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="icon_type" id="icon_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('icon_type') border-red-500 @enderror" required>
                            ...
                            <option value="image" {{ old('icon_type') == 'image' ? 'selected' : '' }}>Image URL</option>
                        </select>
                        @error('icon_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6">
                    ...
                    <div id="icon-input-container">
                        ...
                        <div id="svg-input" class="icon-input-type" style="display: none;">
                            <textarea name="icon_data" id="icon_data_svg" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent font-mono text-sm" placeholder="<svg class=&quot;w-6 h-6&quot; fill=&quot;none&quot; stroke=&quot;currentColor&quot; viewBox=&quot;0 0 24 24&quot;>...</svg>">{{ old('icon_data') }}</textarea>
                        ...
                        <div id="font-awesome-input" class="icon-input-type" style="display: none;">
                            <input type="text" name="icon_data" id="icon_data_fa" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="fas fa-video" value="{{ old('icon_data') }}">
                        ...
                        <div id="image-input" class="icon-input-type" style="display: none;">
                            <input type="text" name="icon_data" id="icon_data_img" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="https://example.com/icon.png" value="{{ old('icon_data') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show initial input based on old value
    const initialType = iconTypeSelect.value;
    if (initialType) {
        showIconInput(initialType);
    }
});
</script>
@endsection
