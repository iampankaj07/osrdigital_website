    ...
    <div class="error-container">
        ...
        <h1 class="error-title">
            @switch($errorCode)
                ...
                @case(500) Server Error @break
                @case(503) Service Unavailable @break
                @default Error {{ $errorCode }} @endswitch
        </h1>
        <p class="error-message">
            @switch($errorCode)
                ...
                @case(401) You need to be authenticated to access this resource. @break
                @case(500) An unexpected error occurred. Please try again later. @break
                @case(503) The service is temporarily unavailable. Please try again later. @break
                @default An error occurred processing your request. @endswitch
        </p>
