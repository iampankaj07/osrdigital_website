                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <button wire:click="confirmDelete({{ $partner->id }}, 'partner')"
    ...
    @if($showSlidePanel)
        ...
        <div class="slide-panel {{ $isClosing ? 'slide-out-right' : '' }}"
            ...
            <div class="slide-panel-header">
                <h5 class="mb-0">
                    @if($isCreating)
                        <i class="fas fa-plus mr-2"></i>Create New Trusted Partner
                    @else
                        <i class="fas fa-edit mr-2"></i>Edit Trusted Partner
                    @endif
                </h5>
            ...
            <div class="slide-panel-body">
                <form wire:submit="{{ $isCreating ? 'store' : 'update' }}">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" wire:model="form.name" class="form-control @error('form.name') is-invalid @enderror" placeholder="Enter partner name">
                        @error('form.name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group mb-3">
                        <label class="form-label">Description</label>
                        <textarea wire:model="form.description" class="form-control @error('form.description') is-invalid @enderror" rows="4" placeholder="Enter partner description"></textarea>
                        @error('form.description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="form-group mb-3">
                        <label class="form-label">Website URL</label>
                        <input type="url" wire:model="form.website_url" class="form-control @error('form.website_url') is-invalid @enderror" placeholder="https://example.com">
                        @error('form.website_url') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between pt-3 border-top mt-4">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-2"></i>{{ $isCreating ? 'Create' : 'Update' }} Partner
                        </button>
                    </div>
                </form>
            </div>
