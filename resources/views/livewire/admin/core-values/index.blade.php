            ...
            <div class="card-body inline-edit-form">
                ...
                <form wire:submit.prevent="store">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="form.title" class="form-control" placeholder="Enter core value title">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" wire:model="form.icon" class="form-control" placeholder="e.g., fas fa-heart">
                        @error('form.icon') <span class="text-danger small">{{ $message }}</span> @enderror
                    </div>
                    
                    <div class="form-group">
                        <label for="form.description">Description</label>
                        <textarea wire:model="form.description" class="form-control" rows="3" placeholder="Enter core value description"></textarea>
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg mx-6 my-4 shadow-sm">
                                        <div class="px-6 py-4 border-b border-gray-100">
                                            <div class="flex items-center">
                                                ...
                                                <h5 class="text-lg font-medium text-gray-900">Edit Core Value</h5>
                                            </div>
                                        </div>
                                        <div class="p-6">
