<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h4 mb-1 font-weight-normal">Partnership Benefits</h1>
            <p class="text-muted small mb-0">Manage partnership benefits and advantages</p>
        </div>
        <button wire:click="create" class="btn btn-dark btn-sm">
            <i class="fas fa-plus mr-1"></i>
            Add Partnership Benefit
        </button>
    </div>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <button wire:click="confirmDelete({{ $benefit->id }}, 'benefit')"
