<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Create Associate</h1>
            <p class="text-muted">Add a new associate company or partner</p>
        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="logo">
                                    {{ $logo ? $logo->getClientOriginalName() : 'Choose file' }}
                                </label>
                            </div>
                            @error('logo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Upload a logo image (max 2MB)</small>
                        </div>
