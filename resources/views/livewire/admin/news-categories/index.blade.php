...
<style>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h4 mb-1 font-weight-normal">News Categories</h1>
            <p class="text-muted small mb-0">Manage news categories and topics</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    @forelse($categories as $category)
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-600 max-w-xs">{{ Str::limit($category->description, 50) }}</div>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h3 class="text-sm font-medium text-gray-900 mb-1">No news categories found</h3>
                                    <p class="text-sm text-gray-500">Create your first news category to get started.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    @if($showSlidePanel)
        ...
        <div class="slide-panel {{ $isClosing ? 'slide-out-right' : '' }}"
            ...
            <div class="slide-panel-header">
                <h5 class="mb-0">
                    @if($isCreating)
                        <i class="fas fa-plus mr-2"></i>Create New News Category
                    @else
                        <i class="fas fa-edit mr-2"></i>Edit News Category
                    @endif
                </h5>
