                        ...
                        @if($old_avatar)
                            <div class="form-group">
                                ...
                                <div class="border p-2 text-center">
                                    <img src="{{ Storage::url($old_avatar) }}" alt="Current Avatar" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="avatar">
                                    {{ $avatar ? $avatar->getClientOriginalName() : 'Choose new file' }}
                                </label>
                            </div>
                            @error('avatar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Upload a new avatar image (max 2MB)</small>
                        </div>
