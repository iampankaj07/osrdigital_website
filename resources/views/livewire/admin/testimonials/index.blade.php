                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150 group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <button wire:click="confirmDelete({{ $testimonial->id }}, 'testimonial')"
    ...
    @if($showSlidePanel)
        ...
        <div class="slide-panel {{ $isClosing ? 'slide-out-right' : '' }}"
            ...
            <div class="slide-panel-header">
                <h5 class="mb-0">
                    @if($isCreating)
                        <i class="fas fa-plus mr-2"></i>Create New Testimonial
                    @else
            ...
            <div class="slide-panel-body">
                <form wire:submit="{{ $isCreating ? 'store' : 'update' }}">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" wire:model="form.name" class="form-control @error('form.name') is-invalid @enderror" placeholder="Enter customer name">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model="form.role" class="form-control @error('form.role') is-invalid @enderror" placeholder="e.g., CEO, Manager">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model="form.company" class="form-control @error('form.company') is-invalid @enderror" placeholder="Company name">
                                @error('form.company') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea wire:model="form.content" class="form-control @error('form.content') is-invalid @enderror" rows="4" placeholder="Enter the testimonial content..."></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" wire:model="form.project" class="form-control @error('form.project') is-invalid @enderror" placeholder="Project or service provided">
                                @error('form.project') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Avatar URL (Alternative)</label>
                        <input type="url" wire:model="form.avatar_url" class="form-control @error('form.avatar_url') is-invalid @enderror" placeholder="https://...">
                        @error('form.avatar_url') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between pt-3 border-top mt-4">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save me-2"></i>{{ $isCreating ? 'Create' : 'Update' }} Testimonial
                        </button>
                    </div>
                </form>
            </div>
